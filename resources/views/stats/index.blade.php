                    ...
                    <div class="x_panel">
                        ...
                        <div class=" noselect x_content">
                            ...
                            <div class="legend">
                                ...
                                <div class="container"
                                     style="background-color: #3299dc; width: 25px; height: 15px; position: relative; left: -230px; top: -13px;"></div>
                                <div style="color: #3299dc; width: 210px; height: 20px; position: relative; border-radius: 5px; left: 40px; top: -37px; font-weight: bold"
...
//                        alert(TotalCompte[i]);
                    ...
                    var OrangePercent = (parseInt(((TotalCompteParOperateur[0] /(TotalCompteParOperateur[0]+ TotalCompteParOperateur[1])) * 100), 10) + '%');
                    var mtnPercent = (parseInt(((TotalCompteParOperateur[1] /(TotalCompteParOperateur[0]+ TotalCompteParOperateur[1])) * 100), 10) + '%');
...
//-------------------donnees total comptes whatsapp et total absence compte whatsapp------
                    ...
                    var ComptePercent = (parseInt(((totalCompteEtNonCompte[0] /(totalCompteEtNonCompte[0]+ totalCompteEtNonCompte[1])) * 100), 10) + '%');
                    var AbsenceComptePercent = (parseInt(((totalCompteEtNonCompte[1] /(totalCompteEtNonCompte[0]+ totalCompteEtNonCompte[1])) * 100), 10) + '%');
...
//---------------------------donnees comptes whatsapp avec photos et pas de photos------------------------
                    ...
                    var CompteAvecPhotosPercent = (parseInt(((totalCompteAvecPhotosEtPasDePhotos[0] /(totalCompteAvecPhotosEtPasDePhotos[0]+ totalCompteAvecPhotosEtPasDePhotos[1])) * 100), 10) + '%');
                    var CompteSansPhotosPercent = (parseInt(((totalCompteAvecPhotosEtPasDePhotos[1] /(totalCompteAvecPhotosEtPasDePhotos[0]+ totalCompteAvecPhotosEtPasDePhotos[1])) * 100), 10) + '%');
...
//----------------------------------compte whatsapp avec photos par operateur-----------------------------------------
                    ...
                    var CompteAvecPhotosOrangePercent = (parseInt(((totalCompteAvecPhotosParOperateur[0] /(totalCompteAvecPhotosParOperateur[0]+ totalCompteAvecPhotosParOperateur[1])) * 100), 10) + '%');
                    var CompteAvecPhotosMtnPercent = (parseInt(((totalCompteAvecPhotosParOperateur[1] /(totalCompteAvecPhotosParOperateur[0]+ totalCompteAvecPhotosParOperateur[1])) * 100), 10) + '%');
...
//-----------------------Comptes Whatsapp Par intervalles Photos---------------------------------------
                    ...
                    var CompteAuPlusCinqPercent = (parseInt(((totalCompteWhatsappParIntervallesPhotos[0] /(totalCompteWhatsappParIntervallesPhotos[0]+ totalCompteWhatsappParIntervallesPhotos[1] + totalCompteWhatsappParIntervallesPhotos[2])) * 100), 10) + '%');
                    var CompteEntreSixEtDixPercent = (parseInt(((totalCompteWhatsappParIntervallesPhotos[1] /(totalCompteWhatsappParIntervallesPhotos[0]+ totalCompteWhatsappParIntervallesPhotos[1]+ totalCompteWhatsappParIntervallesPhotos[2])) * 100), 10) + '%');
                    var CompteSupeieurDixPercent = (parseInt(((totalCompteWhatsappParIntervallesPhotos[2] /(totalCompteWhatsappParIntervallesPhotos[0]+ totalCompteWhatsappParIntervallesPhotos[1] + totalCompteWhatsappParIntervallesPhotos[2])) * 100), 10) + '%');
                    ...
                    var InsertCompteSupeieurDixPercent = '<span style="color: #3299dc; width: 40px; height: 20px; position: relative; border-radius: 5px; left: 211px; top: -27.8px; font-size: 1.1em; font-weight: bold">' + CompteSupeieurDixPercent + '</span>';
